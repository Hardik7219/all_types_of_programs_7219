...
{
  //select winner
   if(u_select=="rock" && cmp_select=="paper" || u_select=="scissors" && cmp_select=="rock" || u_select=="paper" && cmp_select=="scissors")
   {
     cScore++;
     msg.innerText=`cmp win by your ${u_select} and  cmp ${cmp_select}`;
     cmpScore.innerText=cScore;
   }
   else if(u_select=="paper" && cmp_select=="rock" || u_select=="scissors" && cmp_select=="paper" || u_select=="rock" && cmp_select=="scissors" )
   {
     u_Score++;
